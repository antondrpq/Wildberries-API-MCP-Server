...
const FINANCE_RETRY_MAX_ATTEMPTS = Number(process.env.FINANCE_RETRY_MAX_ATTEMPTS || 3);
const FINANCE_RETRY_MIN_WAIT_MS = Number(process.env.FINANCE_RETRY_MIN_WAIT_MS || 5000);
const FINANCE_RETRY_MAX_WAIT_MS = Number(process.env.FINANCE_RETRY_MAX_WAIT_MS || 90000);
